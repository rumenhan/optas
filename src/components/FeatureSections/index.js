    ...
    <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
      ...
      <div className="relative">
        ...
        <p className="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">
          ...
          icing elit. Possimus magnam volupt
          atum cupiditate veritatis in, accusamus quisquam.
        </p>
      </div>
      ...
      <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 ">
        <div className="relative">
          ...
          <p className="mt-3 text-lg leading-7 text-gray-500">
            ...
            elit. Pariatur minima sequi recusandae, porro maiores offici
            a assumenda aliquam laborum ab aliquid veritatis impedit od
            it adipisci optio iste blanditiis facere. Totam, velit.
          </p>
        ...
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8">
          <div className="lg:col-start-2">
            ...
            <p className="mt-3 text-lg leading-7 text-gray-500">
              ...
              Impedit ex obcaecati natus eligendi delectus,
